...
Разработчики утм тоже не стоят не месте, некоторые их решения странные, и могут влиять на работу моей программы, в данный момент у меня она работает с утм версии 2531, ошибок не наблюдал.
